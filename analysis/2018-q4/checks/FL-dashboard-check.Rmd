---
title: "Checking the dashboard data supplied by Florida"
...
- there's a big data artifact in 2015 hunting, which appears to be restricted to residents in their 40s or above (more pronounced for older hunters)
    + especially older hunters (55-64)
    + especially women
    + especially mid-year results
    
I guess I can take a look at the FL data that I have on hand...bla

```{r, eval = FALSE}
source("../../../../dashboard-template/visualize/app-functions.R")
run_visual("FL", pct_range = 1.2)
```
